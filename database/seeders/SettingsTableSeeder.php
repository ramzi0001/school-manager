...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['type' => 'system_title', 'description' => 'ACADEMY ACADEMY'],
            ['type' => 'system_name', 'description' => 'ACADEMY ACADEMY'],
            ['type' => 'term_ends', 'description' => '7/10/2023'],
            ['type' => 'term_begins', 'description' => '7/10/2022'],
            ['type' => 'phone', 'description' => '0123456789'],
            ['type' => 'address', 'description' => '18B North Central Park, alge Center'],
            ['type' => 'system_email', 'description' => 'ACADEMY@ACADEMY.com'],
